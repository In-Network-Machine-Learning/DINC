...
parser SwitchParser(
    ...
    state check_DINC_version {
        ...
        0b00000000000000000000000000000000: parse_DINC0;
        default                    : accept;
        }
    }
    ...
    state parse_DINC0{
        ...
        meta.feature0 = hdr.DINC_meta.storage0[31:0];
        meta.feature1 = hdr.DINC_meta.storage1[31:0];
        meta.feature2 = hdr.DINC_meta.storage2[31:0];
        meta.feature3 = hdr.DINC_meta.storage3[31:0];
        transition accept;
    }
}
...
control SwitchIngress(
    ...
    apply{
        ...
        if (hdr.DINC.isValid()) {
            if (hdr.DINC.E_bitmap[0:0] != 1) {
                lookup_feature0.apply();
                lookup_feature1.apply();
            }
            if (hdr.DINC.E_bitmap == 0b00000000000000000000000000000000){
                hdr.DINC_meta.storage0 = meta.code_f0 ++ meta.code_f1 ++ meta.feature2[28:0];
                hdr.DINC_meta.storage1 = meta.feature2[31:29] ++ meta.feature3[28:0];
                hdr.DINC_meta.storage2[2:0] = meta.feature3[31:29];
            }
