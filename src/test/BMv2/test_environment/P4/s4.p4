...
parser SwitchParser(
    ...
    state check_DINC_version {
        ...
        0b10000000000000000000000000000000: parse_DINC0;
        default                    : accept;
        }
    }
    ...
    state parse_DINC0{
        ...
        meta.feature2 = hdr.DINC_meta.storage0[31:3] ++ hdr.DINC_meta.storage1[2:0];
        meta.feature3 = hdr.DINC_meta.storage1[31:3] ++ hdr.DINC_meta.storage2[2:0];
        transition accept;
    }
}
...
control SwitchIngress(
    ...
    apply{
        ...
        if (hdr.DINC.isValid()) {
            if (hdr.DINC.E_bitmap[1:1] != 1) {
                lookup_feature2.apply();
                lookup_feature3.apply();
            }
            if (hdr.DINC.E_bitmap == 0b10000000000000000000000000000000){
                hdr.DINC_meta.storage0[8:0] = meta.code_f0 ++ meta.code_f1 ++ meta.code_f2 ++ meta.code_f3;
            }
