...
control SwitchIngress(
    ...
    action extract_feature0(out bit<24> meta_code, bit<24> tree){
        meta_code = tree;
    }

    action extract_feature1(out bit<28> meta_code, bit<28> tree){
        meta_code = tree;
    }

    action extract_feature2(out bit<16> meta_code, bit<16> tree){
        meta_code = tree;
    }

    action extract_feature3(out bit<17> meta_code, bit<17> tree){
        meta_code = tree;
    }

    action extract_feature4(out bit<8> meta_code, bit<8> tree){
        meta_code = tree;
    }
...
// dependency marker @!slice, 2!@   @!position, control!@
    ...
    table lookup_leaf_id1 {
        key = { meta.code_f0[4:2]:exact;
                meta.code_f1[6:4]:exact;
    ...
    table lookup_leaf_id3 {
        key = { meta.code_f0[9:7]:exact;
                meta.code_f1[14:11]:exact;
                meta.code_f2[7:6]:exact;
                meta.code_f3[8:7]:exact;
    ...
    table lookup_leaf_id4 {
        key = { meta.code_f0[13:10]:exact;
                meta.code_f1[17:15]:exact;
                meta.code_f2[9:8]:exact;
                meta.code_f3[10:9]:exact;
    ...
    table lookup_leaf_id5 {
        key = { meta.code_f0[17:14]:exact;
                meta.code_f1[20:18]:exact;
    ...
    table lookup_leaf_id6 {
        key = { meta.code_f0[20:18]:exact;
                meta.code_f1[24:21]:exact;
    ...
    table lookup_leaf_id7 {
        key = { meta.code_f0[23:21]:exact;
                meta.code_f1[27:25]:exact;
                meta.code_f2[15:14]:exact;
                meta.code_f3[16:15]:exact;
    ...
    apply{
        ...
        // p4 marker @!metadata_in, bit<32>, feature0!@ @!metadata_in, bit<32>, feature1!@ @!metadata_in, bit<32>, feature2!@ @!metadata_in, bit<32>, feature3!@ @!metadata_in, bit<32>, feature2!@ @!metadata_in, bit<32>, feature4!@
        // p4 marker @!metadata_out, bit<24>, code_f0!@ @!metadata_out, bit<28>, code_f1!@ @!metadata_out, bit<16>, code_f2!@ @!metadata_out, bit<17>, code_f3!@ @!metadata_out, bit<8>, code_f4!@
        ...
        // p4 marker @!metadata_in, bit<24>, code_f0!@ @!metadata_in, bit<28>, code_f1!@ @!metadata_in, bit<16>, code_f2!@ @!metadata_in, bit<17>, code_f3!@ @!metadata_in, bit<8>, code_f4!@
        // p4 marker @!metadata_out, bit<4>, tree_0_vote!@ @!metadata_out, bit<4>, tree_1_vote!@ @!metadata_out, bit<4>, tree_2_vote!@ @!metadata_out, bit<4>, tree_3_vote!@ @!metadata_out, bit<7>, tree_0_prob!@ @!metadata_out, bit<7>, tree_1_prob!@ @!metadata_out, bit<7>, tree_2_prob!@ @!metadata_out, bit<7>, tree_3_prob!@
        ...
        // dependency marker @!slice,2!@ @!previous,0!@ @!position, control-apply!@
        // resource marker @!stage, 2!@ @!memory, 2!@
        // p4 marker @!metadata_in, bit<24>, code_f0!@ @!metadata_in, bit<28>, code_f1!@ @!metadata_in, bit<16>, code_f2!@ @!metadata_in, bit<17>, code_f3!@ @!metadata_in, bit<8>, code_f4!@
        // p4 marker @!metadata_out, bit<4>, tree_4_vote!@ @!metadata_out, bit<4>, tree_5_vote!@ @!metadata_out, bit<4>, tree_6_vote!@ @!metadata_out, bit<4>, tree_7_vote!@ @!metadata_out, bit<7>, tree_4_prob!@ @!metadata_out, bit<7>, tree_5_prob!@ @!metadata_out, bit<7>, tree_6_prob!@ @!metadata_out, bit<7>, tree_7_prob!@
        ...
        // dependency marker @!slice,3!@ @!previous,1,2!@ @!position, control-apply!@
        // resource marker @!stage, 1!@ @!memory, 1!@
        // p4 marker @!metadata_in, bit<4>, tree_0_vote!@ @!metadata_in, bit<4>, tree_1_vote!@ @!metadata_in, bit<4>, tree_2_vote!@ @!metadata_in, bit<4>, tree_3_vote!@ @!metadata_in, bit<7>, tree_0_prob!@ @!metadata_in, bit<7>, tree_1_prob!@ @!metadata_in, bit<7>, tree_2_prob!@ @!metadata_in, bit<7>, tree_3_prob!@ @!metadata_in, bit<4>, tree_4_vote!@ @!metadata_in, bit<4>, tree_5_vote!@ @!metadata_in, bit<4>, tree_6_vote!@ @!metadata_in, bit<4>, tree_7_vote!@ @!metadata_in, bit<7>, tree_4_prob!@ @!metadata_in, bit<7>, tree_5_prob!@ @!metadata_in, bit<7>, tree_6_prob!@ @!metadata_in, bit<7>, tree_7_prob!@
