...
control SwitchIngress(
    ...
    action extract_feature0(bit<32> f0c0, bit<32> f0c1){
        meta.prob_c0 = meta.prob_c0 + f0c0;
        meta.prob_c1 = meta.prob_c1 + f0c1;
    }

    action extract_feature1(bit<32> f1c0, bit<32> f1c1){
        meta.prob_c0 = meta.prob_c0 + f1c0;
        meta.prob_c1 = meta.prob_c1 + f1c1;
    }

    action extract_feature2(bit<32> f2c0, bit<32> f2c1){
    ...
    action extract_feature3(bit<32> f3c0, bit<32> f3c1){
        meta.prob_c0 = meta.prob_c0 + f3c0;
        meta.prob_c1 = meta.prob_c1 + f3c1;
    }

    action extract_feature4(bit<32> f4c0, bit<32> f4c1){
        meta.prob_c0 = meta.prob_c0 + f4c0;
        meta.prob_c1 = meta.prob_c1 + f4c1;
    }
    ...
    action read_class_prob(bit<32> p_c0, bit<32> p_c1){
        meta.prob_c0 = p_c0;
        meta.prob_c1 = p_c1;
    }
