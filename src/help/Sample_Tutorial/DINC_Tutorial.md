...
<aside>
💡 A guide to set up and run distributed DT<sub>EB</sub> (generated by Planter, an automating in-network machine learning framework) on a sample Fat-Tree data canter topology and tested by BMv2.
...
## Let's "Dustributing" DT<sub>EB</sub> now
